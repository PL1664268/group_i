...
public class Client extends JFrame implements MouseListener {
    ...
    public void Login() { //ログイン画面
        ...
        login.addActionListener(new ActionListener() { // ログインボタンを押した時の処理
            public void actionPerformed(ActionEvent as) {
                boolean connectresult = connectServer(ipadress, poat);
    ...
    public void gamewaiting() { //マッチング画面
        ...
        opponentname.setBounds(490,120,300,30);
    ...
    public void score() {//成績確認画面
        ...
        rate.setBounds(500,130,600,40);
        
        //レート
        JLabel rating = new JLabel(String.valueOf((int)myPlayer.getRate()));
        rating.setForeground(text);
        rating.setFont(new Font("ＭＳ ゴシック", Font.BOLD, 40));
        rating.setBounds(550,200,600,40);
    ...
    public void playothello() {//オセロ
        ...
        for(int i = 0 ; i < row * row ; i++){
            ...
            buttonArray[i].setBackground(waku);
        ...
        quitgame.setBounds(275,450,250,50);
    ...
    public void playresult(String winner) { //結果画面
        ...
        reslutt.setFont(new Font("ＭＳ ゴシック", Font.BOLD, 100));
        reslutt.setBounds(0,150,800,100);
        reslutt.setHorizontalAlignment(JLabel.CENTER);
        //レート
        JLabel rate = new JLabel(String.valueOf((int)myrate));
        rate.setForeground(error);
        rate.setFont(new Font("ＭＳ ゴシック", Font.BOLD, 100));
        rate.setBounds(0,280,800,100);
